...
string path = "/home/jokey/Panda/data/WorkData_Range_A" + str_NO_Angle + "_E" +str_Energy  +"_" + str_hz;
int isCreate = ::mkdir(path.c_str(),S_IRUSR | S_IWUSR | S_IXUSR | S_IRWXG | S_IRWXO);
TString prefix = "/home/jokey/Panda/data/WorkData_Range_A" + str_NO_Angle + "_E" +str_Energy  +"_" + str_hz +"/evtcomplete";
...
string theta_min = os1.str(), theta_max = os2.str();
  ...
  TString inputGenerator = "box:type(22,2):p(" + str_Energy +"," + str_Energy  +"):"+ Z_MyTool_GetDeltaTheta(t_min,13.5);
