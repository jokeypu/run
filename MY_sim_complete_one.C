...
#include <sys/stat.h>
#include "/home/jokey/Panda/workspace/plot/Z_MyTool_GetDeltaTheta_one.C"
int MY_sim_complete_one(Int_t NGamma, Int_t NO_Angle, Double_t Energy)
{
...
Double_t BeamMomentum = 1.0;
  ...
  // TString inputGenerator = "box:type(22,2):p(1,1):*";
   TString inputGenerator = "box:type(22," + str_NGamma + "):" + "p(" + str_Energy +"," + str_Energy  +"):" + Z_MyTool_GetDeltaTheta_one(10*NO_Angle, 2.5);
