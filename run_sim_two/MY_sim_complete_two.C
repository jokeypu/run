...
#include "../Z_MyTool_GetDeltaTheta.C"
int MY_sim_complete_two(Int_t NGamma, Int_t NO_Angle, Double_t Energy, TString prefix)
{
Int_t nEvents = 10000;
...
string theta_min = os1.str(), theta_max = os2.str();
  ...
  TString inputGenerator = "box:type(22,"+ str_NGamma +"):p(" + str_Energy +"," + str_Energy  +"):"+ Z_MyTool_GetDeltaTheta(t_min,6.75);
