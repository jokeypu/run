...
int sim_complete(Int_t nEvents = 10, TString SimEngine = "TGeant3", Double_t BeamMomentum = 1.0, TString prefix = "../data/evtcomplete")
{
  //-----User Settings:------------------------------------------------------
  //  gDebug=5;
  ...
  // TString inputGenerator = "box:type(22,2):p(1,1):*";
   TString inputGenerator = "box:type(22,2):p(0.5,0.5):tht(67.0235, 72.9765):phi(-3.375, 3.375)";
