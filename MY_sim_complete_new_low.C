...
#include <sys/stat.h>
int MY_sim_complete_new_low(Int_t NGamma, Int_t NO_Angle, Double_t Energy)
{
...
//system("mkdir "+path);
TString prefix = "/home/jokey/Panda/data/WorkData_" + str_NGamma + "Gamma_A" + str_NO_Angle + "_E" +str_Energy  +"_OR/evtcomplete";
Int_t nEvents = 10000;
