...
int MY_sim_complete_copy(Int_t NGamma, Int_t NO_Angle, Double_t Energy)
{
...
string path = "/home/jokey/Panda/data/copy_WorkData_" + str_NGamma + "Gamma_A" + str_NO_Angle + "_E" +str_Energy  +"_OR";
//mkdir(path.c_str());
int isCreate = ::mkdir(path.c_str(),S_IRUSR | S_IWUSR | S_IXUSR | S_IRWXG | S_IRWXO);
//system("mkdir "+path);
TString prefix = "../data/copy_WorkData_" + str_NGamma + "Gamma_A" + str_NO_Angle + "_E" +str_Energy  +"_OR/evtcomplete";
Int_t nEvents = 10000;
...
Double_t BeamMomentum = 1.0;
  ...
  // TString inputGenerator = "box:type(22,2):p(1,1):*";
   TString inputGenerator = "box:type(22," + str_NGamma + "):" + "p(" + str_Energy +"," + str_Energy  +"):" + Z_MyTool_GetDeltaTheta(10*NO_Angle, 6.75);
